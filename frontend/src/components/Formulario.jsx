...
const Formulario = () => {
  ...
  const [fecha_ingreso, setFecha_ingreso] = useState(Date.now());
  ...
  useEffect(() => {
    if (paciente?.nombre) {
      ...
      setFecha_ingreso(paciente.fecha_ingreso);
  ...
  const handleSubmit = (e) => {
    ...
    if ([nombre, propietario, email, fecha_ingreso, sintomas].includes("")) {
